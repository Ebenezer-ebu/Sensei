    ...
    >
      <div className=' text-right'>
        <button
          ...
          className=' text-xl'
          onClick={() =>
            setApiKey('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')
          }
        >
          <IonIcon icon={closeCircleOutline} />
        </button>
      </div>
      <h2 className='text-xl font-medium text-center my-2'>Enter your apikey</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div className=' flex items-center mt-4'>
          ...
          <span className='ml-2 text-sm font-medium'>Your api key is stored in your own browser or close modal to use mine</span>
        </div>
